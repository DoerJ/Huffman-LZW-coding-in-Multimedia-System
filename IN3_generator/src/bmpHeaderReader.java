// AUTHOR: YUHAO HE
// DATE: 2018.8.2
// DESCRIPTION: The program applies LOSSLESS compression to BMP file
// If read BMP file, the program compresses the image losslessly and
// generates IN3 file
// If read IN3 file, the program decompresses the file and displays the image
...
public class bmpHeaderReader {
    ...
    public static void main(String[] args) {
        ...
        // if IN3 file
            ...
            System.out.println("Reading IN3 file ...\n");

            // reading IN3 file
            IN3Reader read = new IN3Reader(file_path);
        }
    }
