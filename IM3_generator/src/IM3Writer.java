...
public class IM3Writer {
    ...
    IM3Writer(int image_width, int image_height, int r_offset, int g_offset, int b_offset,
    ...
    public void writingHeader() {
        System.out.println("Writing IM3 header ...");
        ...
        try {
            ...
            System.out.println("Writing IM3 codeword streams ...");
